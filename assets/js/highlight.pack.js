var hljs = new (function () {
  ...
  function s(n, r, i) {
    ...
    function s(n) {
      ...
      l +=
        "<" + t(n) + Array.prototype.map.call(n.attributes, r).join("") + ">";
    }
    function o(e) {
      l += "</" + t(e) + ">";
    }
  ...
  function c(t, r, i, a) {
    ...
    function v() {
      ...
      return (
        w.r > 0 && (y += t.r),
        "continuous" == w.subLanguageMode && (L[w.sL] = t.top),
    ...
    function R(t, n) {
      ...
      if (i) {
        var a = w;
        a.rE || a.eE || (B += n), (M += b());
        do w.cN && (M += "</span>"), (y += w.r), (w = w.parent);
        while (w != i.parent);
        return (
          a.eE && (M += e(n)),
          (B = ""),
      ...
      if (f(n, w))
        throw new Error(
          'Illegal lexeme "' + n + '" for mode "' + (w.cN || "<unnamed>") + '"'
        );
    ...
    o(x);
    for (var w = a || x, L = {}, M = "", k = w; k != x; k = k.parent)
      k.cN && (M = g(k.cN, "", !0) + M);
    var B = "",
      y = 0;
    try {
  ...
  function h(e) {
    ...
    if (!/no(-?)highlight/.test(t)) {
      ...
      (o.value = l(o.value)),
        (e.innerHTML = o.value),
        (e.className = f(e.className, t, o.language)),
...
hljs.registerLanguage("python", function (e) {
  ...
  return {
    ...
    c: [
      ...
      b,
      e.HCM,
      e.inherit(n, { cN: "function", bK: "def", r: 10 }),
      e.inherit(n, { cN: "class", bK: "class" }),
      { cN: "decorator", b: /@/, e: /$/ },
      { b: /\b(print|exec)\(/ },
    ],
  };
...
hljs.registerLanguage("bash", function (e) {
  ...
  return {
    ...
    k: {
      keyword:
        "if then else elif fi for break continue while in do done exit return set declare case esac export exec function",
      literal: "true false",
      built_in:
